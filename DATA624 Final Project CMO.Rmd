...
The RMSE for this model is 0.096 with a RM^2 of 0.739.
...
Finally, we will chose our best model for predicting PH amongst the chosen Linear, Non-Linear and Tree Models that we have gone over in this analysis. Their RMSE metrics are summarized here:
...
Next, we will predict the PH values for the evaluation dataset that has been provided using the Random Forest model that was chosen as the best model.
...
Give a recommendation for the boss, no presentation....
